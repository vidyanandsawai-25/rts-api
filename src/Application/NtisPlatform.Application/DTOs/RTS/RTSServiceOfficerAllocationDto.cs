namespace NtisPlatform.Application.DTOs.RTS;

public class RTSServiceOfficerAllocationDto
{
...
public class CreateRTSServiceOfficerAllocationDto
{
    public int ServiceId { get; set; }
    public int? ZoneId { get; set; }
    public string ZoneName { get; set; } = string.Empty;
...
public class UpdateRTSServiceOfficerAllocationDto
{
    public int? ZoneId { get; set; }
    public string ZoneName { get; set; } = string.Empty;
    public string? ZoneNameLocal { get; set; }
