...
public class DepreciationDtos : CommonBaseDtos
{
...
public class CreateDepreciationDto : CreateCommonBaseDtos
{
...
public class UpdateDepreciationDto : UpdateCommonBaseDtos
{
