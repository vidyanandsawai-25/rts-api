...
{
    public class CreatePropertyDetailsDto  : CreateBaseDtos
    {
        [Required]
        ...
        public List<CreateRenterMastDto>? Renters { get; set; }
        public List<CreateRoomWiseSubmissionDetailsDto>? RoomWiseSubmissionDetails { get; set; }
    }
}