...
namespace NtisPlatform.Application.Services
{
    public class AssessmentYearRangeService : BaseCommonCrudService<AssessmentYearRangeEntity, AssessmentYearRangeDto, CreateAssessmentYearRangeDto, UpdateAssessmentYearRangeDto, AssessmentYearRangeQueryParameters, int>, IAssessmentYearRangeService
    {
        ...
        public AssessmentYearRangeService(
            IRepository<AssessmentYearRangeEntity, int> repository,
        ...
        protected override async Task<ValidationResult> ValidateForDeactivationAsync(
            int id,
            AssessmentYearRangeEntity currentEntity,
            AssessmentYearRangeEntity updatedEntity,
            CancellationToken cancellationToken = default)
        {
            if (currentEntity.IsActive && !updatedEntity.IsActive)
            {
                var referenceResult = await _referenceValidator.ValidateReferencesAsync<AssessmentYearRangeEntity>(id, cancellationToken);
        ...
        protected override async Task<ValidationResult> ValidateForDeleteAsync(
            int id,
            AssessmentYearRangeEntity entity,
            CancellationToken cancellationToken = default)
        {
            return await _referenceValidator.ValidateReferencesAsync<AssessmentYearRangeEntity>(id, cancellationToken);
        }

        protected override async Task<ValidationResult> ValidateForCreateAsync(AssessmentYearRangeEntity entity, CancellationToken cancellationToken = default)
        {
