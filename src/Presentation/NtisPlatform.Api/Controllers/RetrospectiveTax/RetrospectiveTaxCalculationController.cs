...
public class RetrospectiveTaxCalculationController : ControllerBase
{
    ...
    [HttpPut("{id}")]
    public Task<IActionResult> Update(long id, [FromBody] UpdateRetrospectiveTaxCalculationDto updateDto, CancellationToken ct)
        => this.ExecuteUpdate(_service, id, updateDto, _logger, ct);

    [HttpPut("Bulk")]
    public Task<IActionResult> BulkUpdate([FromBody] BulkUpdateItem<long, UpdateRetrospectiveTaxCalculationDto>[] items, CancellationToken ct)
    ...
    public Task<IActionResult> Purge(long id, CancellationToken ct)
        => this.ExecuteForceDelete<RetrospectiveTaxCalculationEntity, long>(_cleanupService, _referenceValidationService, id, _logger, ct);

    [Authorize]
    [HttpDelete("Bulk/purge")]
    public Task<IActionResult> BulkPurge([FromBody] long[] ids, CancellationToken ct)
        => this.ExecuteBulkForceDelete<RetrospectiveTaxCalculationEntity, long>(_cleanupService, _referenceValidationService, ids, _logger, ct);
}
