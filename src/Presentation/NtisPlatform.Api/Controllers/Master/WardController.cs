...
public class WardController : ControllerBase
    ...
    [HttpGet]
    public Task<IActionResult> GetAll([FromQuery] WardQueryParameters queryParameters, CancellationToken ct)
    ...
    [HttpPost]
    public Task<IActionResult> Create([FromBody] CreateWardDto createDto, CancellationToken ct)
        => this.ExecuteCreate(_service, createDto, _logger, ct);
           
    [HttpPost("Range")]
    public Task<IActionResult> CreateFromRange([FromBody] RangeCreateRequest<CreateWardDto> request, CancellationToken ct)
        => this.ExecuteCreateFromRange(_service, request, _logger, ct);

    [HttpPost("Bulk")]
    public Task<IActionResult> BulkCreate([FromBody] CreateWardDto[] items, CancellationToken ct)
    => this.ExecuteBulkCreate(_service, items, _logger, ct);
    
    [HttpPut("{id}")]
    public Task<IActionResult> Update(int id, [FromBody] UpdateWardDto updateDto, CancellationToken ct)
        => this.ExecuteUpdate(_service, id, updateDto, _logger, ct);

    [HttpPut("Bulk")]
    public Task<IActionResult> BulkUpdate([FromBody] BulkUpdateItem<int, UpdateWardDto>[] items, CancellationToken ct)
