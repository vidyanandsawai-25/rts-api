...
public class AssetRentDocumentTypeControllerTests
{
    private static AssetRentDocumentTypeController Create(
        out Mock<IAssetRentDocumentTypeService> service,
        Mock<IHardDeleteCleanupService>? cleanupService = null,
        Mock<IReferenceValidationService>? referenceValidationService = null)
    {
        service = new Mock<IAssetRentDocumentTypeService>();
        ...
        var logger = new Mock<ILogger<AssetRentDocumentTypeController>>();
        return new AssetRentDocumentTypeController(service.Object, cleanup.Object, refVal.Object, logger.Object);
    }
    ...
    public async Task GetAll_ReturnsOk()
    {
        ...
        var qp = new AssetRentDocumentTypeQueryParameters { DocumentTypeCode = "LEASE", DocumentTypeName = "Lease Agreement", SearchTerm = "Lease", IsActive = true };
        service.Setup(s => s.GetAllAsync(qp, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new PagedResult<AssetRentDocumentTypeDto>(new List<AssetRentDocumentTypeDto>(), 0, 1, 10));
    ...
    public async Task GetById_Existing_ReturnsOk()
    {
        ...
        service.Setup(s => s.GetByIdAsync(1, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new AssetRentDocumentTypeDto { Id = 1, DocumentTypeCode = "LEASE" });
    ...
    public async Task GetById_NotFound_ReturnsNotFound()
    {
        ...
        service.Setup(s => s.GetByIdAsync(99, It.IsAny<CancellationToken>()))
            .ReturnsAsync((AssetRentDocumentTypeDto?)null);
    ...
    {
        var controller = Create(out var service);
        var dto = new CreateAssetRentDocumentTypeDto { DocumentTypeCode = "LEASE", DocumentTypeName = "Lease Agreement" };
    ...
    {
        var controller = Create(out var service);
        var dto = new UpdateAssetRentDocumentTypeDto { DocumentTypeCode = "LEASE", DocumentTypeName = "Updated Lease" };
    ...
    public async Task Purge_WithValidId_ReturnsOk()
    {
        ...
        cleanupMock.Setup(s => s.ForceHardDeleteAsync<AssetRentDocumentTypeEntity, int>(1, It.IsAny<CancellationToken>()))
            .ReturnsAsync(true);
