...
namespace NtisPlatform.Tests.Application
{
    ...
    Mock<IPropertyRuleApplicationLogService> ruleLogServiceMock
        ...
        public async Task CreatePropertiesFromRangeAsync_ShouldReturnError_WhenTemplateIsNull()
        {
            ...
            var service = new PropertyService(repoMock.Object, uowMock.Object, mapperMock.Object, propRepoMock.Object, mockLogger.Object, featureFlagsMock.Object, wardRepoMock.Object, categoryRepoMock.Object, societyRepoMock.Object, propertyDetailsRepoMock.Object, roomWiseRepoMock.Object, assessmentRepoMock.Object, wardAllocationRepoMock.Object, new Mock<IRepository<OldWardMasterEntity, int>>().Object, propertyMapMasterRepoMock.Object, propertyMapDetailRepoMock.Object, wingRepoMock.Object,userRepoMock.Object, propertyOldRepoMock.Object, propertyTypeRepoMock.Object, new Mock<IRepository<CommunicationDetailsEntity, int>>().Object, new Mock<IRepository<PropertyPhotoEntity, int>>().Object, new Mock<IRepository<DocumentBindingEntity, int>>().Object, new Mock<IRepository<DocumentEntity, int>>().Object, new Mock<IRepository<PropertyPhotoTypeEntity, int>>().Object, new Mock<IRepository<OwnerTypeMasterEntity, int>>().Object, new Mock<IRepository<WingEntity, int>>().Object, ruleLogServiceMock.Object);
