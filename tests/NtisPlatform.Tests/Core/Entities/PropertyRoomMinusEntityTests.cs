...
/// <summary>
/// Unit tests for PropertyRoomMinusEntity
/// </summary>
public class PropertyRoomMinusEntityTests
{
    [Fact]
    public void PropertyRoomMinusEntity_AllProperties_GetSet_WorksCorrectly()
    {
        var now = DateTime.Now;
        var entity = new PropertyRoomMinusEntity
        {
            Id = 1,
    ...
    [Fact]
    public void PropertyRoomMinusEntity_OptionalProperties_CanBeNull()
    {
        var entity = new PropertyRoomMinusEntity
        {
            RoomWiseSubmissionId = 100,
    ...
    [Fact]
    public void PropertyRoomMinusEntity_MarkedForDeletion_DefaultsToFalse()
    {
        var entity = new PropertyRoomMinusEntity();
        Assert.False(entity.MarkedForDeletion);
    }
    ...
    [Fact]
    public void PropertyRoomMinusEntity_NavigationProperty_RoomWiseSubmissionDetails_CanBeSet()
    {
        var minusEntity = new PropertyRoomMinusEntity
        {
            Id = 1,
            RoomWiseSubmissionId = 100
        };
    ...
    [Fact]
    public void PropertyRoomMinusEntity_Dimensions_WorksCorrectly()
    {
        var entity = new PropertyRoomMinusEntity
        {
            LengthMtr = 3.0,
    ...
    [Fact]
    public void PropertyRoomMinusEntity_ShapeAndBases_WorksCorrectly()
    {
        var entity = new PropertyRoomMinusEntity
        {
            Shape = "Trapezoid",
    ...
    [Fact]
    public void PropertyRoomMinusEntity_AreaCalculation_Example()
    {
        var entity = new PropertyRoomMinusEntity
        {
            RoomWiseSubmissionId = 100,
    ...
    [Fact]
    public void PropertyRoomMinusEntity_MultipleMinusAreas_CanBeCreated()
    {
        var minus1 = new PropertyRoomMinusEntity
        {
            Id = 1,
            RoomWiseSubmissionId = 100,
            LengthMtr = 1.0,
        ...
        var minus2 = new PropertyRoomMinusEntity
        {
            Id = 2,
            RoomWiseSubmissionId = 100,
            LengthMtr = 2.0,
